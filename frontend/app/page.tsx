...
import { ChartBarIcon, CursorArrowRaysIcon, DocumentMagnifyingGlassIcon } from "@heroicons/react/24/outline";
                ...
                <div className="container mx-auto w-[90%] max-w-[1200px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-gray-600">Dapatkan analisis mendalam tentang kualitas soal ujian berdasarkan berbagai parameter standar.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <div className="w-12 h-12 bg-[#3cbdb8] rounded-lg flex items-center justify-center mb-4">
                                <CursorArrowRaysIcon width={30} height={30}/>
                            </div>
                            <h3 className="text-xl font-semibold mb-3">Dashboard Interaktif</h3>
                            <p className="text-gray-600">Visualisasi data yang mudah dipahami melalui dashboard interaktif dengan grafik dan tabel.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <div className="w-12 h-12 bg-[#3cbdb8] rounded-lg flex items-center justify-center mb-4">
                            ...
                            <p className="text-gray-600">Generate laporan lengkap yang mencakup semua aspek analisis untuk dokumentasi dan evaluasi.</p>
                        </div>
                    </div>
                </div>
            </div>
